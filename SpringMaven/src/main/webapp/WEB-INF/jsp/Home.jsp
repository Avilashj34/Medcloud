				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="msg" id="msg" required="">
						</div>
				...
				<div class="electronicsinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
							<h3 class="heading-tittle text-center font-italic">Patient Registered</h3>
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Avilash Jha</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">21</span>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html">Chaitanya Gawade</a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price">21</span>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							<h3 class="electronicsits-sear-head mb-3">Search Here..</h3>
							<form action="#" method="post">
						...
						<div class="f-grid py-2">
							<h3 class="electronicsits-sear-head mb-3">How To Use</h3>
							<div class="box-scroll">
								<div class="scroll">
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="${k1}" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 stores_mvd">
											<a href="">First registered</a>
											<a href="" class="price-mar mt-2">Login</a>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-9 col-sm-10 col-9 stores_mvd">
											<a href="">Read Full</a>
											<a href="" class="price-mar mt-2">Instruction </a>
										</div>
									</div>
								</div>
							</div>
