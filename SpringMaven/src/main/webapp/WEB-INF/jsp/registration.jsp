				...
				<div class="modal-body">
					<form action="patientlogin" method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder=" " name="emailid" required="">
						</div>
						<div class="form-group">
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="checkout-left">
				<div class="address_form_electronics mt-sm-5 mt-4">
					...
					<form action="register" method="post" class="creditly-card-form electronicsinfo_form" enctype="multipart/form-data">
						<div class="creditly-wrapper electronics-stroe, stores_electronicsits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									...
									<div class="controls form-group">
										<select class="option-storesls" name="gender">
						...
						<input type="submit" name="register" value="Submit Your Data">
					</form>
