				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="Doctordashboard">Home
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
						...
						<div class="flexslider">
							<ul class="slides">
								...
								<div class="thumb-image">
										<img src="GetDoctorPic/<c:out value='<%=d.getDoctorid() %>'/>" data-imagezoom="true" class="img-fluid" /> </div>
								</li>
							</ul>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h4 class="mb-3"><%=d.getFirstname() +" "+  d.getLastname() %></h4>
					<p class="mb-3">
						<span class="item_price">Speciality In : <%=d.getSpecialty() %></span>
					</p>
					...
					<div class="product-single-storesl">
						...
						<p class="my-sm-4 my-3">
							<i class="fas fa-retweet mr-3"></i>Enter the E-Mail Id Of Patient
