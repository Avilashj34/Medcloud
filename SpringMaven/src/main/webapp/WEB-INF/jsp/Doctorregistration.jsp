		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				<div class="electronicsits-navi_search">
					<a href="Doctorregistration"><h5>Reload</h5></a>
				</div>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="checkout-left">
				<div class="address_form_electronics mt-sm-5 mt-4">
					...
					<form action="doctorprocess" method="post" class="creditly-card-form electronicsinfo_form" enctype="multipart/form-data">
